<template>
	<view>
		<view class="top">
			...
			<view class="touxiang">
				<button class="bottom" open-type="getUserInfo" lang="zh_CN" @getuserinfo="onGotUserInfo">
					<image class="tx-img" :src="yonghuwx.avatarUrl"></image>
				</button>

			</view>
			<view class="book-code">取书码</view>
			<view class="username" v-if="!flag">登录</view>
			<view class="username" v-else>{{yonghuwx.nickName}}</view>
			...
			<view class="badge-wall" @click="go('/pages/xunzhang/xunzhang')">
		...
		<view class="book" @click="go('/pages/shou/shou')">
		...
		<view class="city" @click="go('/pages/city/city')">
			<icon class="iconfont icon-qiehuan"></icon>
			<text class="name">切换城市</text>
			<icon class="iconfont icon-xiangyoujiantou"></icon>
		</view>
		<view class="leading-readers">
